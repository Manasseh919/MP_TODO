...
const index = () => {
  ...
  const fetchTaskData = async () => {
    try {
      const response = await axios.get("https://backend-mp-todo.onrender.com/todos/count");
  ...
  return (
    <View style={{ padding: 10, flex: 1, backgroundColor: "white" }}>
      ...
      <View style={{width:400,backgroundColor:"#89CFF0",marginTop:50,marginLeft:'auto',marginRight:'auto',borderRadius:25}} >
        <TouchableOpacity onPress={logout} style={{paddingHorizontal:10,marginVertical:10}}>
